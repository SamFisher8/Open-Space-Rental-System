                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" pattern="[0-9]{11}" maxlength="11" id="phone" name="phone" placeholder="Enter Phone Number" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" pattern="[0-9]{10}" maxlength="10" id="nid" name="nid" placeholder="Enter NID" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               <select name="user_Type" class="form-control" id="type">
                                   <option value="0">I'm Renting my Space</option>
                                   <option value="1">I'm looking for Space</option>
                               </select>
                            </div>
                        </div>
